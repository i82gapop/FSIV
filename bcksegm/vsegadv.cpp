...
main (int argc, char * const argv[])
{
    ...
    while(was_Ok && key!=27)
    {
        ...
        /*std::cout << parametros.thresholdf << " " << parametros.ste_radius << " " << parametros.bframes << " " << parametros.stup << " " << parametros.ltup
                << " " << parametros.alfaf << " " << parametros.gauss_radius << std::endl;*/
        //
    }

    if(!was_Ok){

        std::cerr << "Video terminado.\n";
        return EXIT_SUCCESS;
    }
