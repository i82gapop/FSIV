...
main (int argc, char* const* argv)
{
  ...
  try {
      ...
      if (validate)
      {
          ...
          if(!compute_features_from_list(train_images,
                                    train_rois,
                                    canonical_size,
                                    train_descs,
                                    feature_id,
          ...
          if(!compute_features_from_list(val_images,
                                         val_rois,
                                         canonical_size,
                                         val_descs,
                                         feature_id,
      ...
      else
      {
          ...
          if(!compute_features_from_list(test_images,
                                     test_rois,
                                    canonical_size,
                                     val_descs,
                                         feature_id,
      ...
      if (validate)
      {
          ...
          else if (classifier == 2)
          {
              ...
              cv::TermCriteria criteria =  cv::TermCriteria(cv::TermCriteria::COUNT + cv::TermCriteria::EPS,rtrees_T,rtrees_E);
