...
public:
    ...
    Parametros(cv::Mat dentro, double g, int r1, int r2, int filter_type, bool circular, bool luma){
...
void trackbar_callback_g(int g, void* parametros)
{
    ...
    aux->fuera = fsiv_image_sharpening(aux->dentro, (double)(aux->g)/100, (int)aux->filter_type, (bool)aux->luma, (int)(aux->r1), (int)(aux->r2), (bool)aux->circular);
...
main (int argc, char* const* argv)
{
  ...
  try {    
      ...
      if(parser.has("i")){
          ...
          Parametros parametros(input, g, r1, r2, filter_type, circular, luma);
          ...
          parametros.fuera = fsiv_image_sharpening(input, g, filter_type, luma, r1, r2, circular);
      ...
      output = fsiv_image_sharpening(input, g, filter_type, luma, r1, r2, circular);
